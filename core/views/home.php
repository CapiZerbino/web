<!-- <div class="container">
  <h1 class="py-2">Home</h2>
    <p>This is the main page.</p>
    Tip: <i>this page is more empty than my brain.</i>
</div> -->
<div class="page-content">
    <!-- Section Banner -->
    <div class="dez-bnr-inr dez-bnr-inr-md" style="background-image:url(images/jobbg.jpg);">
        <div class="container">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="icon-bx-wraper">
                        <div class="icon-content">
                            ...
                            <a href="recruit/all" class="dez-tilte">Design, Art & Multimedia</a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="icon-bx-wraper">
                        <div class="icon-content">
                            ...
                            <a href="recruit/all" class="dez-tilte">Education Training</a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="icon-bx-wraper">
                        <div class="icon-content">
                            ...
                            <a href="recruit/all" class="dez-tilte">Accounting / Finance</a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="icon-bx-wraper">
                        <div class="icon-content">
                            ...
                            <a href="recruit/all" class="dez-tilte">Human Resource</a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="icon-bx-wraper">
                        <div class="icon-content">
                            ...
                            <a href="recruit/all" class="dez-tilte">Telecommunications</a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="icon-bx-wraper">
                        <div class="icon-content">
                            ...
                            <a href="recruit/all" class="dez-tilte">Restaurant / Food Service</a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="icon-bx-wraper">
                        <div class="icon-content">
                            ...
                            <a href="recruit/all" class="dez-tilte">Construction / Facilities</a>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="icon-bx-wraper">
                        <div class="icon-content">
                            ...
                            <a href="recruit/all" class="dez-tilte">Health</a>
